...
function advanced(): string { return disclosure("Advanced options", toggleControl("sound-enabled", "Sound", soundEnabled, "Keyboard ticks and outcome beeps")); }
